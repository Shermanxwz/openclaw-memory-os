...
LLM_URL = os.environ.get("LLM_CHAT_URL", os.environ.get("OLLAMA_URL", "http://127.0.0.1:11434").rstrip("/") + "/api/chat")
LLM_MODEL = os.environ.get("MEMORY_BRAIN_LLM_MODEL", "qwen2.5:1.5b")
