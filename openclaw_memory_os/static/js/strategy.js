        ...
        if (stateNode) {
          stateNode.innerHTML = '' +
            '<table><tbody>' +
              ...
              '<tr><th>30d 自动晋升</th><td>' + OC.escapeHTML(String(state.promotions_last_30d || 0)) + '</td></tr>' +
              '<tr><th>连续回滚</th><td>' + OC.escapeHTML(String(state.consecutive_rollbacks || 0)) + '</td></tr>' +
              '<tr><th>Shadow 对照</th><td>' + OC.escapeHTML(String((state.shadow_comparisons || []).length)) + '</td></tr>' +
