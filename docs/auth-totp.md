...
The code fallback is 12 hours when `MEMORY_OS_SESSION_MAX_AGE` is unset. Production deployments should set it explicitly; this host currently pins 30 days:

```bash
MEMORY_OS_SESSION_MAX_AGE=2592000  # 30 days
```
